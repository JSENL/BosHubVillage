...
-- Rename the main local resources table to local_resources
...
DROP POLICY IF EXISTS "Allow public read access to local resources and nonprofits" ON public.local_resources;
DROP POLICY IF EXISTS "Allow authenticated users to insert local resources and nonprofits" ON public.local_resources;
DROP POLICY IF EXISTS "Allow authenticated users to update local resources and nonprofits" ON public.local_resources;
DROP POLICY IF EXISTS "Allow authenticated users to delete local resources and nonprofits" ON public.local_resources;
...
DROP POLICY IF EXISTS "Anyone can view local resources comments" ON public.local_resources_comments;
DROP POLICY IF EXISTS "Authenticated users can create local resources comments" ON public.local_resources_comments;
DROP POLICY IF EXISTS "Users can update their own local resources comments" ON public.local_resources_comments;
DROP POLICY IF EXISTS "Users can delete their own local resources comments" ON public.local_resources_comments;
