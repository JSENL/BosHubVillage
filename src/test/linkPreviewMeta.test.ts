...
describe("link preview metadata", () => {
  it("uses absolute HubVillage logo URLs for Open Graph and Twitter", () => {
    ...
    const logoUrl = "https://bos-hub-village.vercel.app/lovable-uploads/cormorant.png";
    ...
    expect(source).toContain('bos-hub-village.vercel.app/search?q={search_term_string}');
