...
import { X, MapPin, Calendar, Clock, DollarSign, Building, Tag } from 'lucide-react';
...
export const MapItemSidebar = ({ selectedItem, onClose }: MapItemSidebarProps) => {
  ...
  return (
    <div className="absolute top-4 right-4 w-80 bg-white rounded-lg shadow-lg border border-gray-200 z-50 max-h-[calc(100vh-2rem)] overflow-y-auto">
